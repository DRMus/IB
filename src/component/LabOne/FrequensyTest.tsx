  ...
  return (
    <Card>
      ...
      {statistics <= 1.82138636 && (
        <h3 style={{color: "green"}}>{`${statistics} <= 1.82138636, тест успешно пройден, последовательность случайная`}</h3>
      )}
      {statistics > 1.82138636 && (
        <h3 style={{color: "red"}}>{`${statistics} > 1.82138636, тест не пройден, последовательность неслучайная`}</h3>
      )}
      <div>{statistics}</div>
    </Card>
  );
